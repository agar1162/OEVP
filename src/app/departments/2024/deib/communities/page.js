        ...
        <div>
            ...
            <div id="COMMUNITIES_DESCRIPTIONS_CONTAINER" className="mx-[5%] md:mx-[15%] pt-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-[1fr_1px_1fr] border-x border-b border-[#E1E1E1] bg-white font-[Georgia] text-[#000000] text-[13px] leading-[1.6]">
                    ...
                    <ul className="list-disc list-inside">
                        <li>
                        <a href="https://cejce.berkeley.edu/clsd">Chicanx Latinx Student Development (CLSD)</a>
                        </li>
                        <li>
                        <a href="https://www.instagram.com/lsa.ucb/?hl=en">Latinx Student Union (LSU)</a>
                        </li>
                        <li>
                        <a href="https://lrc.berkeley.edu/">Latinx Research Center</a>
                        </li>
                    </ul>
                    <br />
                    ...
                    <ul className="list-disc list-inside">
                        <li>
                        <a href="https://cejce.berkeley.edu/clsd/latinx-student-resource-center">Latinx Resource Center</a>
                        </li>
                        <li>
                        <a href="http://undocu.berkeley.edu/">Undocumented Student Program</a>
                        </li>
                        <li>
                        <a href="https://www.instagram.com/ucbnasd/p/DBuBCFzyq3i/">Día de los Muertos Celebrations</a>
                        </li>
                    </ul>
                    <br />
                    ...
                    <ul className="list-disc list-inside pl-4">
                        ...
                        <a href="https://eop.berkeley.edu/services-programs/schedule-appointment">Schedule an Appointment</a> (EOP is a program that helps students balance personal and academic responsibilities: receive support for selecting courses, transitioning into UC Berkeley, dealing with financial aid, etc.)
                        </li>
                        <li>
                        <a href="https://undocu.berkeley.edu/financial-support#:~:text=Undocumented%20students%20with%20AB540%20and,and%20scholarships%2C%20and%20private%20scholarships.">Financial Aid for Undocumented Students</a>
                        </li>
                        <li>
                        <a href="https://dream.csac.ca.gov/landing">California Dream Act</a>
                        </li>
                    </ul>
                    <br />
                    ...
                    <ul className="list-disc list-inside pl-4">
                        <li>
                        <a href="https://latinbayarea.com/berkeley-dia-de-los-muertos-festival/">Día de los Muertos celebrations (cultural festivals)</a>
                        </li>
                        <li>
                        Academic workshops
                        </li>
                ...
                {activeSection === "ind_all" && (
                    ...
                    <div className="px-5 pt-4 pb-4 md:pb-6">
                        <div className="text-[15px] mb-2">Organizations and Student Groups</div>
                        <ul className="list-disc list-inside">
                        <li><a href="https://callink.berkeley.edu/organization/nativeamericanrrc">Indigenous Native Coalition Recruitment and Retention Center</a></li>
                        <li><a href="https://issi.berkeley.edu/crnai">Joseph Myers Center for Research on Native American Issues</a></li>
                        <li><a href="https://soundcloud.com/indigenousunited">Indigenous United (Native American Student Development Podcast)</a></li>
                        <li><a href="https://cejce.berkeley.edu/calndnds">Cal NDNs (Natives of Diverse Nations)</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="px-5 pt-4 pb-4 md:pb-6">
                        ...
                        <li><a href="https://cejce.berkeley.edu/nasd">Native American Student Development Office</a></li>
                        <li><a href="https://jsp-ls.berkeley.edu/legal-studies-undergraduate-program/about-major/land-acknowledgement-statement">land acknowledgment tools</a></li>
                        <li><a href="https://financialaid.berkeley.edu/types-of-aid-at-berkeley/innovative-berkeley-aid-programs/native-american-opportunity-plan/#:~:text=American%20Opportunity%20Plan-,Native%20American%20Opportunity%20Plan,Indian,%20and%20Alaska%20Native%20tribes.">Native American Oppurtunity Plan</a></li>
                        </ul>
                        ...
                        <div className="text-[13px] mb-1">Events:</div>
                        <ul className="list-disc list-inside pl-8">
                            <li><a href="https://cejce.berkeley.edu/centers/native-american-student-development/native-events/uc-berkeley-pow-wow">U.C. Berkeley Powwows</a></li>
                            <li><a href="https://www.ipdpowwow.org/">Indigenous Peoples' Day</a></li>
                            <li><a href="https://reslife.berkeley.edu/academics/theme-programs/native-american-theme-program/">Native American Theme Program (NATP)</a></li>
                            <li><a href="https://cejce.berkeley.edu/centers/native-american-student-development/visitors-and-prospective-student-information/jumpstart">Native Jumpstart & Natives Transcending Programs</a></li>
                            <li><a href="https://diversity.universityofcalifornia.edu/actions/academic-pipeline/undergrad-students/resources-for-native-american-students.html#:~:text=UC's%20Native%20American%20Opportunity%20Plan%20ensures%20that%20in%2Dstate%20systemwide,to%20undergraduate%20and%20graduate%20students.">Financial Aid Resources for Native American Students</a></li>
                        </ul>
                        </div>
                    </div>
                    </div>
                ...
                {activeSection === "mena_all" && (
                    ...
                    <div className="px-5 pt-4 pb-4 md:pb-6">
                        <div className="text-[15px] mb-2">Organizations and Student Groups</div>
                        <ul className="list-disc list-inside">
                        <li><a href="https://berkeleymsa.org/" className="underline not-italic">Muslim Student Association (MSA)</a></li>
                        <li><a href="https://menagroup.haas.berkeley.edu/" className="underline not-italic">MENA Student Development</a></li>
                        <li><a href="https://callink.berkeley.edu/organization/jsa" className="underline not-italic">Jain Students Association</a></li>
                        <li><a href="https://callink.berkeley.edu/organization/ucbssa" className="underline not-italic">Sikh Students Association</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="px-5 pt-4 pb-4 md:pb-6">
                        <div className="text-[15px] mb-2">Resources and Events</div>
                        <ul className="list-disc list-inside"> 
                        <li><a href="https://studentaffairs.berkeley.edu/news-messages/student-services-and-support-during-ramadan-2024/" className="underline not-italic">Ramadan Support</a></li>
                        <li><a href="https://berkeleymsa.org/spaces" className="underline not-italic">Prayer Spaces</a></li>
                        <li><a href="https://berkeleymsa.org/eid-ramadan-accommodations" className="underline not-italic">Eid and Ramadan Exam Accommodations</a></li>
                        <li><a href="https://diversity.berkeley.edu/arab-american-heritage-month" className="underline not-italic">Ramadan Iftars & Arab Heritage Month</a></li>
                        </ul>
                        ...
                        <ul className="list-disc list-inside pl-8">
                            <li><a href="https://www.instagram.com/asha_berkeley/" className="underline not-italic">Asha for Education</a></li>
                            <li><a href="https://www.instagram.com/berkeleybpshi/" className="underline not-italic">BPSHI (Healthcare Initiative for Immigrants)</a></li>
                            <li><a href="https://www.instagram.com/berkeleysahaara/" className="underline not-italic">UC Berkeley Sahaara (Anti-Sex Trafficking Project)</a></li>
                            <li><a href="https://www.instagram.com/jeevaclinic/" className="underline not-italic">Jeeva Clinic (South Asian Health Awareness)</a></li>
                            <li><a href="https://www.projectrishi.org/" className="underline not-italic">Project RISHI (Rural India Social and Health Improvement)</a></li>
                            <li><a href="https://www.instagram.com/ucb_pph/" className="underline not-italic">Palestinian Public Health at Berkeley</a></li>
                        </ul>
                        </div>
                    </div>
                    </div>
                ...
                {activeSection === "aapi_all" && (
                    ...
                    <div className="px-5 pt-4 pb-4 md:pb-6">
                        ...
                        <li><a className="not-italic" href="https://cejce.berkeley.edu/apasd">Asian Pacific American Student Development (APASD)</a></li>
                        <li><a className="not-italic" href="https://www.instagram.com/cal.reach/?hl=en">Asian Pacific Islander Recruitment and Retention Center (REACH)</a></li>
                        <li><a className="not-italic" href="https://callink.berkeley.edu/organization/asianamericanassociation">Asian American Association (AAA)</a></li>
                        <li><a className="not-italic" href="https://callink.berkeley.edu/organization/SASC">Southeast Asian Student Coalition (SEASC)</a></li>
                        <li><a className="not-italic" href="https://pass.studentorg.berkeley.edu/">Philippinx Academic Student Services (PASS)</a></li>
                        <li><a className="not-italic" href="https://berkeleyclubs.com/club/BerkeleyCambodianStudentsAssociation">Berkeley Cambodian Students Association</a></li>
                        </ul>

                        <div className="mt-3 text-[13px]">Professional Development:</div>
                        <ul className="list-disc list-inside pl-8">
                        <li><a className="not-italic" href="https://callink.berkeley.edu/organization/apalsa">Asian Pacific American Pre-Law Association</a></li>
                        <li><a className="not-italic" href="https://career.berkeley.edu/communities/asian-american-pacific-islander/">Asian Career Network</a></li>
                        <li><a className="not-italic" href="https://callink.berkeley.edu/organization/bcssa">Chinese Students and Scholars Association</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="px-5 pt-4 pb-4 md:pb-6">
                        ...
                        <li><a className="not-italic" href="https://diversity.berkeley.edu/sites/default/files/aapisc-2021-report-final_0.pdf">AAPI representation and diversity within the student body</a></li>
                        <li><a className="not-italic" href="https://docs.google.com/document/d/18UOradc0WlJC6_M6yVdDzepL09yuFauy9-E-2KlPk4Y/edit?tab=t.0#heading=h.gugfmiro0i">AAPI Mental Wellness Guide</a></li>
                        </ul>

                        <div className="text-[13px] mb-1">Events:</div>
                        <ul className="list-disc list-inside pl-8">
                        <li><a className="not-italic" href="https://events.berkeley.edu/student-events/event/235245-lunar-new-year-celebration">Lunar New Year</a></li>
                        <li><a className="not-italic" href="https://diversity.berkeley.edu/asian-american-and-pacific-islander-heritage-month">Heritage Celebrations</a></li>
                        </ul>
                    </div>
                    </div>
                )}
                ...
                {activeSection === "jewish_all" && (
                    ...
                    <div className="px-5 pt-4 pb-4 md:pb-6">
                        <div className="text-[15px] mb-2">Organizations and Student Groups</div>
                        <ul className="list-disc list-inside">
                        <li><a href="https://berkeleyhillel.org/">Berkeley Hillel</a></li>
                        <li><a href="https://www.jewishucb.com/">Chabad Jewish Student Center</a></li>
                        <li><a href="https://berkeleyhillel.org/jews-of-color-collective/">Jews of Color Collective</a></li>
                        <li><a href="https://berkeleyhillel.org/gaavah/">Cal Ga’avah (Queer Judaism Organization)</a></li>
                        <li><a href="https://jewse.studentorg.berkeley.edu/">JEWSE: Jews in Science and Engineering</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="px-5 pt-4 pb-4 md:pb-6">
                        ...
                        <ul className="list-disc list-inside pl-8">
                            <li><a href="https://jewishstudies.berkeley.edu/">Center for Jewish Studies</a></li>
                            <li><a href="https://helendillerinstitute.berkeley.edu/home">Helen Diller Institute for Jewish Law and Israel Studies</a></li>
                            <li><a href="https://magnes.berkeley.edu/">The Magnes Collection of Jewish Art and Life</a></li>
                        </ul>
                        </div>
                        ...
                        <ul className="list-disc list-inside pl-8">
                            <li><a href="https://jewishstudies.berkeley.edu/courses-degree-programs/scholarship/grants-fellowships-prizes">Anne and Benjamin Goor Prize in Jewish Studies</a></li>
                            <li><a href="https://www.law.berkeley.edu/admissions/jd/financial-aid/types-of-aid/scholarships/outside-agency-scholarships-private/scholarships-for-jewish-students/">Scholarships for Jewish Students</a></li>
                        </ul>
                        </div>
                        ...
                        <ul className="list-disc list-inside pl-8">
                            <li><a href="https://jewishstudies.berkeley.edu/antisemitism-education">Antisemitism Education Initiative</a></li>
                            <li><a href="https://jewishstudies.berkeley.edu/antisemitism-education/antisemitism-education-resources">Antisemitism Education Resources</a></li>
                            <li><a href="https://jewishstudies.berkeley.edu/antisemitism-education/antisemitism-training-film">Antisemitism Training Film</a></li>
                        </ul>
                        </div>
                        ...
                        <ul className="list-disc list-inside pl-8">
                            <li><a href="https://uhs.berkeley.edu/about-uhs/especially/jewish-students">Berkeley Hillel Wellness Resources</a></li>
                            <li><a href="https://diversity.berkeley.edu/support-uc-berkeley-jewish-community">Support for the UC Berkeley Jewish Community</a></li>
                            <li><a href="https://deanofstudents.berkeley.edu/our-resources/support/resources-support-trauma-tragedies-loss/">Resources & Support for Trauma, Tragedies, and Loss</a></li>
                        </ul>
                        </div>
                        ...
                        <ul className="list-disc list-inside pl-8">
                            <li><a href="https://diversity.berkeley.edu/jewish-american-heritage-month">Jewish American Heritage Month Celebrations</a></li>
                            <li><a href="https://magnes.berkeley.edu/">The Magnes Collection Exhibitions</a></li>
                        </ul>
                        </div>
                    </div>
                    </div>
                ...
                {activeSection === "lgbtq_all" && (
                    ...
                    <div className="px-5 pt-4 pb-4 md:pb-6">
                        <div className="text-[15px] mb-2">Organizations and Student Groups</div>
                        <ul className="list-disc list-inside">
                        <li><a href="https://callink.berkeley.edu/organization/QC">Queer Caucus at Berkeley Law</a></li>
                        <li><a href="https://callink.berkeley.edu/organization/qappa">Queer & Allied Pre-Med/Pre-Health Association (QAPPA)</a></li>
                        <li><a href="https://mba.haas.berkeley.edu/student-life/lgbtq">Q@Haas (LGBTQ MBA Community)</a></li>
                        <li><a href="https://callink.berkeley.edu/organization/queeringpublichealth">Queering Public Health</a></li>
                        <li><a href="https://callink.berkeley.edu/organization/calqueerandasian">Cal Queer & Asian</a></li>
                        <li><a href="https://eecs.berkeley.edu/people/students-2/organizations/">Queer Graduate Students in Computer Science and Electrical Engineering (Q|CSE)</a></li>
                        <li><a href="https://polisci.berkeley.edu/belonging/belonging-berkeley-political-science">Queer Political Scientists (QPS)</a></li>
                        <li><a href="https://cejce.berkeley.edu/centers/gender-equity-resource-center/resources/lgbtq-resources/community-resources">Gamma Rho Lambda (TPA) - All-Gender-Inclusive Sorority</a></li>
                        <li><a href="https://cejce.berkeley.edu/centers/gender-equity-resource-center/resources/lgbtq-resources/community-resources">iGenSpectrum (Queer Physicists)</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="px-5 pt-4 pb-4 md:pb-6">
                        <div className="text-[15px] mb-2">Resources and Events</div>
                        <ul className="list-disc list-inside">
                        <li><a href="https://uhs.berkeley.edu/">LGBTQIA+ Mental Health Support</a></li>
                        <li><a href="https://cejce.berkeley.edu/centers/gender-equity-resource-center/resources/transgender-resources/housing">Queer Housing Resources</a></li>
                        </ul>
