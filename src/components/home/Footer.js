...
//             src="/ASUC-logo.png"
//             alt="ASUC Logo"
//             className="h-[160px] w-[160px] sm:h-[180px] sm:w-[180px] lg:h-[208px] lg:w-[209px] object-contain mt-2 mx-auto sm:mx-0"
//           />
//           <div className="max-w-full sm:max-w-[400px] flex flex-col gap-[6px] pt-5">
//             <h2 className="text-[#F9B416] text-[20px] sm:text-[24px]">ASUC Newsletter</h2>
//             <p className="leading-[24px] tracking-wide text-[13.5px] sm:text-[14px]">
//               Get access to the latest resources, discover the projects and
//               initiatives student leaders are driving, and learn how your student
//               government can support your goals.
//             </p>
//             <a
//               href="https://asuc.substack.com/subscribe"
//               className="bg-[#F9B416] text-black text-[13.5px] py-2 px-4 rounded w-fit mt-5"
//             >
//               Sign Up for the ASUC Newsletter
//             </a>
//           </div>
...
//         {/* Columns Section */}
//         <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 pt-[10px] mt-[10px] w-full">
//           {/* Column: Home */}
...
//           {/* Column: Inquiries */}
//           <div className="flex flex-col gap-3">
//             <h3 className="text-[18px] mb-[6px]">Inquiries</h3>
//             <p>
//               Email:{" "}
//               <a href="mailto:evp@asuc.org" className="underline">
//                 evp@asuc.org
...
//             <h3 className="text-[18px] mb-[6px]">Follow Us</h3>
//             <div className="flex items-center gap-[8px]">
//               <a href="https://www.instagram.com/ucbvicepresident/">
//                 <img src="/insta.png" alt="Instagram" className="w-[36px] h-[36px]" />
//               </a>
//               <a href="https://www.facebook.com/theASUC/">
//                 <img src="/face.png" alt="Facebook" className="w-[43px] h-[43px] object-contain" />
//               </a>
//             </div>
//             <a href="https://www.ocf.berkeley.edu/" className="mt-8">
//               <img
...
export default function Footer() {
  return (
    <footer className="bg-berkeley text-white font-[Georgia] text-[14px] px-8 py-[55px]">
      <div className="max-w-[1300px] mx-auto flex flex-col lg:flex-row lg:justify-between gap-[50px]">
        {/* Left: Logo + Newsletter */}
        <div className="flex flex-col sm:flex-row gap-8 lg:gap-[40px] w-full lg:w-auto items-start">
          <img
            src="/ASUC-logo.png"
            alt="ASUC Logo"
            // className="h-[160px] w-[160px] sm:h-[180px] sm:w-[180px] lg:h-[208px] lg:w-[209px] object-contain"
            className="h-[160px] w-[160px] sm:h-[180px] sm:w-[180px] lg:h-[220px] lg:w-[221px] object-contain lg:mt-[12px]"
          />
          {/* <div className="max-w-[420px] flex flex-col gap-[6px] pt-4"> */}
          <div className="max-w-[420px] flex flex-col gap-[6px] lg:pt-[10px]">
            <h2 className="text-[#F9B416] text-[20px] sm:text-[24px]">
              ASUC Newsletter
            </h2>
            <p className="leading-[24px] tracking-wide text-[13.5px] sm:text-[14px]">
              Get access to the latest resources, discover the projects and
        ...
        {/* Right Columns: Home, Inquiries, Follow Us */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex gap-10 w-full lg:w-auto lg:pt-[10px]">
          {/* Column: Home */}
